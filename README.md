...
```sh
$ go get -u -v github.com/Alex950808/proxypool
```

### 下载预编译程序

从这里下载预编译好的程序 [release](https://github.com/Alex950808/proxypool/releases)

### 使用docker

```sh
docker pull docker.pkg.github.com/Alex950808/proxypool/proxypool:latest
```
